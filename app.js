...
app.post('https://script.google.com/macros/s/AKfycbwUp43bKrKpBkRzDkWsfKhdUE5zccWl8AZFumvwv71oDvdbfIeJq4U10y99udtsISeN/exec', async (req, res) => {
...
// Iniciar servidor
app.listen(PORT, () => {
    console.log(`🚀 Servidor ejecutándose en https://script.google.com/macros/s/AKfycbwUp43bKrKpBkRzDkWsfKhdUE5zccWl8AZFumvwv71oDvdbfIeJq4U10y99udtsISeN/exec`);
});
